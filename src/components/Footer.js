      ...
      <section class='social-media'>
        <div class='social-media-wrap'>
          ...
          <div
              ...
              <a href="https://www.facebook.com/nilanjan.guha.988/" rel="noopener noreferrer" target="_blank">
                <i style={{ color: '#4267B2' }} class='fab fa-facebook' aria-label='Facebook' />
              </a>
            </div>
            <div
              class='social-icon-link instagram'>
              <a href="https://www.instagram.com/teamtx_finithic/" rel="noopener noreferrer" target="_blank">
                <i style={{ color: '#F56040' }} class='fab fa-instagram' aria-label='Instagram' />
              </a>
            </div>
            <div
              class='social-icon-link youtube'>
              <a href="https://www.youtube.com/channel/UCR2ITgJJ1L6Y0cbnadc7h_A" rel="noopener noreferrer" target="_blank">
           ...
           <div
            ...
            <div
              ...
              <a href="https://www.linkedin.com/in/nilanjan-guha-5b3bba18a/" rel="noopener noreferrer" target="_blank">
